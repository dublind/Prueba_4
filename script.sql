...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE atencion_clientes';
EXCEPTION
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE pagos';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE horarios';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE colaboradores';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE usuarios_barber';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
